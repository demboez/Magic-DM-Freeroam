...
[![sampctl](https://shields.southcla.ws/badge/sampctl-y_ini-2f2f2f.svg?style=for-the-badge)](https://github.com/YSI-Storage/y_ini)
...
```bash
sampctl package install YSI-Storage/y_ini
```
